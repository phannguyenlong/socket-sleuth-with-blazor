...
import editors.BTPHttpResponseEditor;
...
public class BTPHttpResponseEditorProvider implements HttpResponseEditorProvider {
    ...
    private BTPHttpResponseEditor BTPHttpResponseEditor;
    ...
    public BTPHttpResponseEditor getBTPHttpResponseEditor() {
        return BTPHttpResponseEditor;
    }
    ...
    public ExtensionProvidedHttpResponseEditor provideHttpResponseEditor(EditorCreationContext editorContext) {
        this.BTPHttpResponseEditor = new BTPHttpResponseEditor(this._montoya, editorContext.editorMode());
        return this.BTPHttpResponseEditor;
    }
}
